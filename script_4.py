# Create the visualization utilities
visualizations_content = '''import plotly.express as px
...
with open('utils/visualizations.py', 'w', encoding='utf-8') as f:
    f.write(visualizations_content)

print("✅ Created utils/visualizations.py - Visualization utilities")
print(f"File size: {len(visualizations_content)} characters")