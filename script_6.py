...
# User Analytics Page
user_analytics_content = '''import streamlit as st
import pandas as pd
...
with open('pages/user_analytics.py', 'w', encoding='utf-8') as f:
    f.write(user_analytics_content)

with open('pages/__init__.py', 'w', encoding='utf-8') as f:
    f.write('')

print("✅ Created pages/user_analytics.py - User analytics page")
print(f"File size: {len(user_analytics_content)} characters")